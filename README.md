...
It truly believe that this engine can finds itself as a [pushdown automata](https://brilliant.org/wiki/pushdown-automata/), which is before [turing machines](https://brilliant.org/wiki/turing-machines/) in the [automata theory](https://en.wikipedia.org/wiki/Automata_theory).
