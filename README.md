...
| `@write` | Write on the standard output the given argument. It can also print the value of a variable by preceeding it with a `%` | `?[The number is %n lol@write]` | Prints 'The number is ', then the value of *n*, then ' lol'. |
